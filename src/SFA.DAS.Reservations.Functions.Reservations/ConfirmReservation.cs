...
namespace SFA.DAS.Reservations.Functions.Reservations
{
    public class ConfirmReservation
    {
        ...
        public static async Task Run([NServiceBusTrigger(QueueName = "testEndpoint")] ConfirmReservationMessage message, ILogger log, [Inject] IConfirmReservationHandler handler)
        {
